...
export const experiences: Position[] = [
    {
        ...
        descriptionList: [
            ...
            "Created and managed Docker Swarm mode clusters for container orchestration across multiple on-premise machines. Utilized an Nginx reverse proxy on manager nodes to route external HTTPS requests to the ingress routing mesh. Integrated Cloudflare for DNS and SSL/TLS management.",
