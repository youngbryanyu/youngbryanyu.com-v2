...
export const experiences: Position[] = [
    {
        ...
        descriptionList: [
            ...
            "Developed and maintained several microservices essential to the core product function. Created and maintained internal developer documentation and external documentation for developers using our service.",
