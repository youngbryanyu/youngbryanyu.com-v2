...
export const experiences: Position[] = [
    {
        ...
        descriptionList: [
            ...
            "Built a CI/CD pipeline to automate unit testing, building/tagging/pushing Docker images, updating applications in multiple environments with zero-downtime rolling deployments, and managing infrastructure. Improved image build times by leveraging an external layer cache with BuildKit. Optimized overall pipeline efficiency by parallelizing independent pipeline steps, caching dependencies, and processing commits in batches.",
